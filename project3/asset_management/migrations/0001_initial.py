# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-20 15:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('location', models.TextField(blank=True, choices=[('San Jose', 'San Jose, CA, USA'), ('Los Angeles', 'Los Angeles, CA, USA'), ('Denver', 'Denver, CO, USA'), ('Madrid', 'Madrid, Spain'), ('Paris', 'Paris, FrancLe'), ('Beijing', 'Beijing, China')], null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Manufacturer',
